                        ...
                        <div class="footer-app-download">
                            ...
                            <div class="footer-app-content">
                                ...
                                <div class="footer-app-qr">
                                    ...
                                    <img
                                        src="{{asset('frontend/img/qr_code_scan_app_upgrade.png')}}"
            ...
            <div class="col-lg-4">
                ...
                <ul class="social">
                    @if($settings->facebook)
                        <li><a target="_blank" aria-label="فيسبوك"><i class="fab fa-facebook-f"></i></a></li>
                    @endif
                    @if($settings->whatsapp)
                        <li><a target="_blank" aria-label="واتساب"><i class="fab fa-whatsapp"></i></a></li>
                    @endif
                    @if($settings->twitter)
                        <li><a target="_blank" aria-label="تويتر"><i class="fab fa-twitter"></i></a></li>
                    @endif
                    @if($settings->snapchat_ghost)
                        <li><a target="_blank" aria-label="سناب شات"><i class="fab fa-snapchat"></i></a></li>
                    @endif
