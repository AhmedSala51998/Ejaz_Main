            ...
            <div class="col-lg-4">
                ...
                <ul class="connect">
                    ...
                    @elseif(Cookie::get('branch') == 'jeddah')
                      <li><i class="fa-solid fa-location-dot"></i> الأمير فيصل، حي الخالدية، جدة 23423</li>
                    @elseif(Cookie::get('branch') == 'riyadh')
                        <li><i class="fa-solid fa-location-dot"></i> 3032 الرياض، حي الملك فيصل، شارع أم المؤمنين سودة بنت زمعه</li>
                    @else
                        <li><i class="fa-solid fa-location-dot"></i> {{$settings->address1??"السعودية - الرياض - شارع الوحدة"}}</li>
                    @endif
                    ...
                    <li><i class="fa-solid fa-phone"></i> <a href="https://api.whatsapp.com/send?phone={{$settings->phone3}}">{{$settings->phone3}}</a> - <a href="https://api.whatsapp.com/send?phone={{$settings->phone4}}">{{$settings->phone4}}</a></li>
                    <li><i class="fa-solid fa-envelope"></i> <a href="mailto:{{$settings->email1}}">{{$settings->email1}}</a></li>
                </ul>
                <ul class="social">
