            ...
            <div class="col-lg-4">
                ...
                <ul class="connect">
                    @if(Cookie::get('branch') == 'yanbu')
                      <li><i class="fa fa-location-dot"></i> {{$settings->address1??"السعودية - الرياض - شارع الوحدة"}}</li>
                    @elseif(Cookie::get('branch') == 'jeddah')
                      <li><i class="fa fa-location-dot"></i> الأمير فيصل، حي الخالدية، جدة 23423</li>
                    @elseif(Cookie::get('branch') == 'riyadh')
                        <li><i class="fa fa-location-dot"></i> 3032 الرياض، حي الملك فيصل، شارع أم المؤمنين سودة بنت زمعه</li>
                    @else
                        <li><i class="fa fa-location-dot"></i> {{$settings->address1??"السعودية - الرياض - شارع الوحدة"}}</li>
                    @endif
                    ...
                    <li><i class="fa fa-phone-office"></i> <a href="https://api.whatsapp.com/send?phone={{$settings->phone1}}">{{$settings->phone1}}</a> - <a href="https://api.whatsapp.com/send?phone={{$settings->phone2}}">{{$settings->phone2}}</a></li>
                    <li><i class="fa fa-phone-plus"></i> <a href="https://api.whatsapp.com/send?phone={{$settings->phone3}}">{{$settings->phone3}}</a> - <a href="https://api.whatsapp.com/send?phone={{$settings->phone4}}">{{$settings->phone4}}</a></li>
                    <li><i class="fa fa-envelope"></i> <a href="mailto:{{$settings->email1}}">{{$settings->email1}}</a></li>
                </ul>
                <ul class="social">
