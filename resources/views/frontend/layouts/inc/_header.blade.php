    ...
    <div class="container-fluid">
        <section class="header-inner">
            <a class="navbar-brand" href="{{route('home')}}">
                ...
                <img src="{{$settings->header_logo?get_file($settings->header_logo):asset('frontend/img/logo.svg')}}" width="100" height="75" fetchpriority="high" decoding="async" class="header-logo" alt="Company Logo">
            </a>
