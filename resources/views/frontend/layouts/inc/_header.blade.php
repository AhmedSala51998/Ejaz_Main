    ...
    <div class="container-fluid">
        <section class="header-inner">
            <a class="navbar-brand" href="{{route('home')}}">
                ...
                <img src="{{$settings->header_logo?get_file($settings->header_logo):asset('frontend/img/logo.svg')}}" width="100" height="65" fetchpriority="high" decoding="async" class="header-logo" alt="Company Logo">
            </a>
            ...
            <div class="moreActions d-none d-lg-block">
                <a href="{{route('frontend.show.ourStaff')}}" class="cta-button">
                    خدمة العملاء
...
<div id="mobileSidebar" class="mobile-sidebar">
    <div class="sidebar-header text-center">
        <a href="{{ route('home') }}" class="logo-link animate-logo">
            <img src="{{ asset('frontend/img/logo.png') }}" width="85" height="65" fetchpriority="high" decoding="async" class="img-fluid logo-img" alt="شعار">
        </a>
