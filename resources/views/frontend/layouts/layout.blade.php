...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/png" href="https://isteqdamejaz.com/frontend/img/google-logo.png">
    <link rel="shortcut icon" type="image/x-icon" href="https://isteqdamejaz.com/frontend/img/google-logo.png">
...
(function () {
  ...
  window.addEventListener('mousemove', loadZoho, { once: true });
    ...
    })(window,document,'script','dataLayer','GTM-PB86BHCX');</script>
