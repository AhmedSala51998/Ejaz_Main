...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/png" href="https://isteqdamejaz.com/frontend/img/logo4.png">
    <link rel="shortcut icon" type="image/x-icon" href="https://isteqdamejaz.com/frontend/img/logo4.png">
