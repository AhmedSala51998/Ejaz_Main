...
(function () {
  const styles = [
    "{{asset('frontend/css/fontawesome.min.css')}}",
    "{{asset('frontend/css/swiper-bundle.min.css')}}",
    "{{asset('frontend/css/animate.min.css')}}",
    "{{asset('frontend/css/aos.css')}}",
    "{{asset('frontend/css/dropify.min.css')}}",
    "{{asset('frontend/css/jquery.fancybox.min.css')}}",
    "{{asset('frontend/css/odometer.min.css')}}",
    "{{asset('frontend/css/select2.min.css')}}",
    "{{asset('frontend/backEndFiles/validation/toastr.min.css')}}",
    "{{asset('frontend/backEndFiles/sweetalert/sweetalert.css')}}",
    "{{asset('frontend/css/introjs.css')}}",
    "{{asset('frontend/css/introjs-rtl.css')}}"
  ];
