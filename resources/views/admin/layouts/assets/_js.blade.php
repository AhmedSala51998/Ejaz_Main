...
<script src="{{asset('dashboard/assets/libs/jquery-validation/jquery.validate.min.js')}}"></script>

<script src="{{ asset('dashboard/cute-alert-master/cute-alert.js') }}"></script>
